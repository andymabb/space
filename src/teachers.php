...
<title>The Space Yoga Studio - Our Teachers &amp; Trainers</title>
<meta name="description" content="The Space Yoga Studio, Thame - List of yoga Teachers and Trainers">
...
<div class="teacher-list">
	<a href="teacher.php?t=ginny-moffett" class="teacher-card">
		...
		<span class="teacher-info">
			<p class="teacher-name">Ginny Moffett</p>
			<span class="teacher-title">Teacher Trainer / Teacher, Classical Hatha &amp; Ashtanga Vinyasa Yoga</span>
		</span>
	</a>
	...
	<!-- <a href="teacher.php?t=hayley-napier" class="teacher-card">
...
<!-- 	<a href="teacher.php?t=emma-lever" class="teacher-card">
	...
	<a href="teacher.php?t=georgie-davies" class="teacher-card">
		...
		<span class="teacher-info"><p class="teacher-name">Georgie Davies</p>
			<span class="teacher-title">Vinyasa Flow</span></span>
	</a>
	<a href="teacher.php?t=tiffany-redman" class="teacher-card">
	...
	<!-- <a href="teacher.php?t=philippa-barclay" class="teacher-card">
	...
	<!-- <a href="teacher.php?t=stephanie-clarkson" class="teacher-card">
	...
	<!-- <a href="teacher.php?t=philly-gray" class="teacher-card">
	...
	<!-- <a href="teacher.php?t=alicia-roscoe" class="teacher-card">
	...
	<!-- <a href="teacher.php?t=carrie-highmore" class="teacher-card">
	...
	<a href="teacher.php?t=sarah-o-hanlon" class="teacher-card">
		<div class="teacher-image"><img src="images/teachers/sarah-o-hanlon.jpg" alt="Sarah O'Hanlon"></div>
		<span class="teacher-info"><p class="teacher-name">Sarah O'Hanlon</p>
			<span class="teacher-title">Dynamic Hatha Flow</span></span>
	</a>

	<a href="teacher.php?t=mette-bengtsson_pratt" class="teacher-card">
		<div class="teacher-image"><img src="images/teachers/mette-bengtsson_pratt.jpg" alt="Mette Bengtsson-Pratt"></div>
		<span class="teacher-info"><p class="teacher-name">Mette Bengtsson-Pratt</p>
			<span class="teacher-title">Ashtanga Yoga</span></span>
	</a>

	<a href="teacher.php?t=lisa-wehbe" class="teacher-card">
		<div class="teacher-image"><img src="images/teachers/lisa-wehbe.jpg" alt="Lisa Wehbe"></div>
		<span class="teacher-info"><p class="teacher-name">Lisa Wehbe</p>
			<span class="teacher-title">Hatha Yoga</span></span>
	</a>
	...
	<a href="teacher.php?t=carl-hinton" class="teacher-card">
		...
		<span class="teacher-info">
			<p class="teacher-name">Carl Hinton</p>
			<span class="teacher-title">Ashtanga Yoga</span></span>
	</a>
